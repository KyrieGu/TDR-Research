...
<body>
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form role="form" method="post" action="logout_check.php">
				<div class="form-group">
					<label for="delete_user_uid">E-mail:</label>
					<input type="text" class="form-control" name="delete_user_uid" id="delete_user_uid">
				</div><!--
				<div class="checkbox">
