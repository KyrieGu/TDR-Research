...
public class RTXYChart extends JFrame {
 ...
 /*   public XYSeries series5;		// dataset for valid zero crossings
    ...
    public RTXYChart(String title){
    	...
    	series2 = new XYSeries("Y");
    	series3 = new XYSeries("X");
    	series4 = new XYSeries("Y");
...
//        lens_label = new JLabel(html1 + "250" + html2 + "", JLabel.CENTER);
    ...
    private JFreeChart createRTChart(String t, XYDataset[] dataset ) {
		...
		domainAxis.setNumberFormatOverride(new NumberFormat() {
			...
			public StringBuffer format(long number, StringBuffer toAppendTo,
				...
				toAppendTo.append((long )number/1000);
				return toAppendTo;
			}
			...
			public StringBuffer format(double number, StringBuffer toAppendTo,
					FieldPosition pos) {
				toAppendTo.append((double)number/1000);
				// TODO Auto-generated method stub
				return toAppendTo;
			}
		});
...
//		domainAaxis.setDateFormatOverride(new SimpleDateFormat("MMM-yyyy"));
		...
		rangeAxis.setFixedAutoRange(10);
		rangeAxis.setTickLabelFont(font);
		
		plot1.setDomainAxis(0, domainAxis);
		plot1.setRangeAxis(0, rangeAxis);
		plot1.setBackgroundPaint(getForeground());
...
//		plot1.setBackgroundPaint(new Color(0, 51, 0));
		...
		plot1.setDataset(1, dataset[0]);
		plot1.setRenderer(1, renderer5);
		
		plot1.mapDatasetToDomainAxis(1, 0);
		plot1.mapDatasetToRangeAxis(1, 0);
		
		// Plot samples
		XYItemRenderer renderer2 = new XYLineAndShapeRenderer(true, false);   // Shapes only
		renderer2.setSeriesShape(0, new Ellipse2D.Double(-1,-1,2,2));
...
//				plot1.setBackgroundPaint(new Color(0, 51, 0));
		...
		plot1.setDataset(2, dataset[1]);
		plot1.setRenderer(2, renderer2);
		...
		XYItemRenderer renderer0 = new XYLineAndShapeRenderer(true, false);   // Shapes only
//		renderer5.setSeriesShape(0, new Ellipse2D.Double(-1,-1,2,2));
//		renderer5.setSeriesPaint(0, Color.red);
//		renderer5.setSeriesStroke(0, new BasicStroke(2, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL));
		renderer0.setSeriesShape(0, new Ellipse2D.Double(-0,-0,0,0));
		renderer0.setSeriesPaint(0, Color.gray);
		renderer0.setSeriesStroke(0, new BasicStroke(0, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL));
		renderer0.isSeriesVisible(0);
		
//		plot1.setDomainCrosshairVisible(true); 
//		plot1.setRangeCrosshairVisible(true);
////		plot1.setBackgroundPaint(new Color(0, 51, 0));
//		
//		plot1.setDataset(3, dataset[2]);
//		plot1.setRenderer(3, renderer0);
//		
//		plot1.mapDatasetToDomainAxis(3, 0);
//		plot1.mapDatasetToRangeAxis(3, 0);
...
//		plot1.setBackgroundPaint(new Color(0, 51, 0));
		...
		XYItemRenderer renderer4 = new XYLineAndShapeRenderer(true, false);   // Shapes only
		renderer4.setSeriesShape(0, new Ellipse2D.Double(-0,-0,0,0));
		renderer4.setSeriesPaint(0, Color.gray);
		renderer4.setSeriesStroke(0, new BasicStroke(0, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL));
		renderer4.isSeriesVisible(0);
//		renderer5.setSeriesShape(0, new Ellipse2D.Double(-1,-1,2,2));
//		renderer5.setSeriesPaint(0, Color.red);
//		renderer5.setSeriesStroke(0, new BasicStroke(2, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL));
...
//		plot1.setBackgroundPaint(new Color(0, 51, 0));
		...
		plot1.setDataset(4, dataset[3]);
		plot1.setRenderer(4, renderer4);
