...
//            Sound2.reset();
    ...
    static void PlaySound(final int soundNum){
        if(Sound1.isPlaying() || Sound1.isLooping()) {
...
//            Sound1.reset();
        ...
        if(Sound2.isPlaying() || Sound2.isLooping()) {
...
//            Sound2.reset();
        ...
        if(Sound3.isPlaying() || Sound3.isLooping()) {
...
/*                    try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sound2 = MediaPlayer.create(this, R.raw.rain);
        Sound3 = MediaPlayer.create(this, R.raw.river);
