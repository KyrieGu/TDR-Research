...
public class CreateFlowerGUI2 extends Application {
	...
	public static final String SCOPE = "SIS.Tien.2";
	// name of this component
    public static final String NAME = "FlowerGUI2";
...
class MonitorTask implements Runnable {
	...
	public void runTask() {
		while (running) {
			try {
				...
				conn.putPair("Scope", CreateFlowerGUI2.SCOPE);
				...
				conn.putPair("Name", CreateFlowerGUI2.NAME);
	...
	private void ProcessMsg(KeyValueList kvList) throws Exception {
		...
		if (!CreateFlowerGUI2.SCOPE.startsWith(scope)) {
			return;
		}
		...
		case "Connect":
			...
			if (!name.equals(CreateFlowerGUI2.NAME)&&!role.equals("Monitor")) {
