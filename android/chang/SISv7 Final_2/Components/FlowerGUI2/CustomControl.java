...
public class CustomControl extends VBox {
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Scope", CreateFlowerGUI2.SCOPE);
			kill.putPair("MessageType", "Setting");
			kill.putPair("Sender", CreateFlowerGUI2.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Scope", CreateFlowerGUI2.SCOPE);
				act.putPair("MessageType", "Setting");
				act.putPair("Sender", CreateFlowerGUI2.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateFlowerGUI2.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateFlowerGUI2.NAME);
