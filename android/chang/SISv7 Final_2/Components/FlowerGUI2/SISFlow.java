...
public class SISFlow extends GridPane {
	...
	public void handlerChange(MouseEvent event){
		try {
			...
			if(builder.length()>0){
				...
				updateEmail.putPair("Scope", CreateFlowerGUI2.SCOPE);
				updateEmail.putPair("MessageType", "Setting");
				updateEmail.putPair("Sender", CreateFlowerGUI2.NAME);
	...
	public void handlerSwitch(MouseEvent event){
		try {
			...
			switchUser.putPair("Scope", CreateFlowerGUI2.SCOPE);
			switchUser.putPair("MessageType", "Setting");
			switchUser.putPair("Sender", CreateFlowerGUI2.NAME);
