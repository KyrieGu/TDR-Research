...
public class CustomControl extends VBox {
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Scope", CreateChiGUI.SCOPE);
			kill.putPair("MessageType", "Setting");
			kill.putPair("Sender", CreateChiGUI.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Scope", CreateChiGUI.SCOPE);
				act.putPair("MessageType", "Setting");
				act.putPair("Sender", CreateChiGUI.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateChiGUI.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateChiGUI.NAME);
