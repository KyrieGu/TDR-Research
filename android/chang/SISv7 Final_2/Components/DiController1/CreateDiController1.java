...
public class CreateDiController1 {
	...
	private static final String NAME = "DiController1";
	// messages types that can be handled by this component
	private static final List<String> TYPES = new ArrayList<String>(
			Arrays.asList(new String[] { "Setting", "Reading", "Alert", "Confirm", "Emergency" }));

	// summary for all incoming / outgoing messages
	private static final String incomingMessages = "IN\tConfirm|Setting:Kill||Alert:TempAlert";
	...
	static void ProcessMsg(KeyValueList kvList) throws IOException {
		...
		case "Alert":
			...
			case "Temp":
				switch (purpose) {
				case "TempAlert":
					System.out.println("TemptoDiController1 received, start processing...");
