...
public class SISFlow extends GridPane {
	...
	public void handlerChange(MouseEvent event){
		try {
			...
			if(builder.length()>0){
				...
				updateEmail.putPair("Scope", CreateFlowerGUI.SCOPE);
				updateEmail.putPair("MessageType", "Setting");
				updateEmail.putPair("Sender", CreateFlowerGUI.NAME);
	...
	public void handlerSwitch(MouseEvent event){
		try {
			...
			switchUser.putPair("Scope", CreateFlowerGUI.SCOPE);
			switchUser.putPair("MessageType", "Setting");
			switchUser.putPair("Sender", CreateFlowerGUI.NAME);
