...
public class SISFlow extends GridPane {
	...
	public void handlerChange(MouseEvent event){
		try {
			...
			if(builder.length()>0){
				...
				updateEmail.putPair("Scope", CreateRenGUI.SCOPE);
				updateEmail.putPair("MessageType", "Setting");
				updateEmail.putPair("Sender", CreateRenGUI.NAME);
	...
	public void handlerSwitch(MouseEvent event){
		try {
			...
			switchUser.putPair("Scope", CreateRenGUI.SCOPE);
			switchUser.putPair("MessageType", "Setting");
			switchUser.putPair("Sender", CreateRenGUI.NAME);
