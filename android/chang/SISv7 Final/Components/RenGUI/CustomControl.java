...
public class CustomControl extends VBox {
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Scope", CreateRenGUI.SCOPE);
			kill.putPair("MessageType", "Setting");
			kill.putPair("Sender", CreateRenGUI.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Scope", CreateRenGUI.SCOPE);
				act.putPair("MessageType", "Setting");
				act.putPair("Sender", CreateRenGUI.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateRenGUI.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateRenGUI.NAME);
