...
public class CreateFlowerGUI extends Application {
	...
	public static final String SCOPE = "SIS.Tien.1";
	// name of this component
    public static final String NAME = "FlowerGUI";
...
class MonitorTask implements Runnable {
	...
	public void runTask() {
		while (running) {
			try {
				...
				conn.putPair("Scope", CreateFlowerGUI.SCOPE);
				...
				conn.putPair("Name", CreateFlowerGUI.NAME);
	...
	private void ProcessMsg(KeyValueList kvList) throws Exception {
		...
		if (!CreateFlowerGUI.SCOPE.startsWith(scope)) {
			return;
		}
		...
		case "Connect":
			...
			if (!name.equals(CreateFlowerGUI.NAME)&&!role.equals("Monitor")) {
