...
public class CustomControl extends VBox {
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Scope", CreateFlowerGUI.SCOPE);
			kill.putPair("MessageType", "Setting");
			kill.putPair("Sender", CreateFlowerGUI.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Scope", CreateFlowerGUI.SCOPE);
				act.putPair("MessageType", "Setting");
				act.putPair("Sender", CreateFlowerGUI.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateFlowerGUI.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateFlowerGUI.NAME);
