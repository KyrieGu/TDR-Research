    ...
    private static void ProcessMsg(KeyValueList kvList) throws Exception {
        ...
        switch (messageType) {
			...
			case "Reading"://Liang	According chiSensor's send message
				...
				reading.mDate=Long.parseLong(kvList.getValue("datetime"));
...
*/
			...
			//Compute V1
			String V1="Abnormal";	//20160518
			DBSCAN d = new DBSCAN();//20160518 
			String V1Sql;//20160518
			V1Sql="Select * From records where uid='" + reading.uid + "' order by rid desc";//DATEDIFF(NOW(),datetime)<30 and //20160518
			if(d.isMajor(3, 2, reading.VT, reading.VF, reading.VW, reading.VP, reading.VS, "records", V1Sql) == true){//20160518
				V1="Normal";//20160518
			}//20160518
    ...
    private static void uploadChiTotal() {
        try {
			if(reading.source_Sender.equals("ChiWebGUI")){
