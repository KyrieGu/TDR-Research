...
public class CreateFlowerPower2 {
    ...
    private static final String NAME = "FlowerPower2";
	...
	private static FlowerReading reading = new FlowerReading();
	...
	private static void initRecord() {
		...
		alert.putPair("Purpose", "FlowerPowerAlert2");
	...
	private static void componentTask() {
		try {
			...
			if(reading.preDateFP!=reading.dateFP){
				alert.putPair("AirTemperature", reading.temperature + "");
				alert.putPair("Fertilizer", reading.fertilizer + "");
				alert.putPair("Light", reading.sunshine + "");
				alert.putPair("Moisture", reading.moisture + "");
				alert.putPair("Date", reading.dateFP + "");
	...
	private static void fetch() throws Exception {
		...
		params.put("username", "chang@cs.pitt.edu");
		params.put("password", "al2105be");
		params.put("client_id", "chang@cs.pitt.edu");
		params.put("client_secret", "j5GnRSnE94Py1lpPkffu5pAuD1zN9las6ahmEYD1pKEtqI0w");
