...
public class CreateReadingBehaviorManager {
	...
	private static final String NAME = "ReadingBehaviorManager";
	// messages types that can be handled by this component
	private static final List<String> TYPES = new ArrayList<String>(
			Arrays.asList(new String[] { "Setting", "Reading", "Alert", "Confirm" }));

	// summary for all incoming / outgoing messages
	private static final String incomingMessages = "IN\tConfirm|Setting:Kill||Alert:ReadingBehaviorAlert";
	...
	static void ProcessMsg(KeyValueList kvList) throws IOException {
		...
		// Behaviour
		 case "Setting":
		    ...
		    case "ReadingBehavior":
				switch (purpose) {
				case "ReadingBehaviorAlert":
					System.out.println("ReadingBehaviortoReadingBehaviorManager received, start processing...");
		...
		case "Confirm":
			...
			break;
		// You may define more cases here
		}
