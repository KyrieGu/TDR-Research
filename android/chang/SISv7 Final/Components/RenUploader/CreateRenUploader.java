...
public class CreateRenUploader
{
    ...
    private static final String NAME = "RenUploader";
    ...
    private static void ProcessMsg(KeyValueList kvList) throws Exception
    {
        ...
        case "Alert":
            ...
            case "BloodPressure":
                ...
                break;
            case "EKG":
                String leadISeq = kvList.getValue("LeadISeq");
                String leadIISeq = kvList.getValue("LeadIISeq");
                String leadIIISeq = kvList.getValue("LeadIIISeq");
                String datEK = kvList.getValue("Date");
                if (leadISeq != null && !leadISeq.equals("")) {
                    reading.leadISeq = leadISeq;
                }
                if (leadIISeq != null && !leadIISeq.equals("")) {
                    reading.leadIISeq = leadIISeq;
                }
                if (leadIIISeq != null && !leadIIISeq.equals("")) {
                    reading.leadIIISeq = leadIIISeq;
                }
                if (datEK != null && !datEK.equals(""))
                {
                    reading.dateEKG = Long.parseLong(datEK);
                }
                break;
            case "SPO2":
    ...
    private static void update() throws Exception
    {
        ...
        execute(formQuery(reading.dateEKG,"EKG","leadISeq",reading.leadISeq));
        execute(formQuery(reading.dateEKG,"EKG","leadIISeq",reading.leadIISeq));
        execute(formQuery(reading.dateEKG,"EKG","leadIIISeq",reading.leadIIISeq));
...
class UploaderReading
{
    ...
    public String toString()
    {
        ...
        builder.append("LeadISeq: " + leadISeq + "\n");
        builder.append("LeadIISeq: " + leadIISeq + "\n");
        builder.append("LeadIIISeq: " + leadIIISeq + "\n");
