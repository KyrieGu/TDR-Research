...
public class CustomControl extends VBox {
	...
	//private final String SCOPE = "SIS.Tien.1";
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Scope", CreateReadingBehaviorGUI.SCOPE);
			kill.putPair("MessageType", "Setting");
			kill.putPair("Sender", CreateReadingBehaviorGUI.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Scope", CreateReadingBehaviorGUI.SCOPE);
				act.putPair("MessageType", "Setting");
				act.putPair("Sender", CreateReadingBehaviorGUI.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateReadingBehaviorGUI.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateReadingBehaviorGUI.NAME);
