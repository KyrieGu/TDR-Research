...
public class CreateReadingBehaviorGUI extends Application {
    ...
    public static final String NAME = "ReadingBehaviorGUI";
...
class MonitorTask implements Runnable {
	...
	public void runTask() {
		while (running) {
			try {
				...
				conn.putPair("Scope", CreateReadingBehaviorGUI.SCOPE);
				...
				conn.putPair("Name", CreateReadingBehaviorGUI.NAME);
	...
	private void ProcessMsg(KeyValueList kvList) throws Exception {
		...
		if (!CreateReadingBehaviorGUI.SCOPE.startsWith(scope)) {
			return;
		}
		...
		case "Connect":
			...
			if (!name.equals(CreateReadingBehaviorGUI.NAME)&&!role.equals("Monitor")) {
