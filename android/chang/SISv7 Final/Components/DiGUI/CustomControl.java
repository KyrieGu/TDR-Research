...
public class CustomControl extends VBox {
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Scope", CreateDiGUI.SCOPE);
			kill.putPair("MessageType", "Setting");
			kill.putPair("Sender", CreateDiGUI.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Scope", CreateDiGUI.SCOPE);
				act.putPair("MessageType", "Setting");
				act.putPair("Sender", CreateDiGUI.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateDiGUI.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateDiGUI.NAME);
