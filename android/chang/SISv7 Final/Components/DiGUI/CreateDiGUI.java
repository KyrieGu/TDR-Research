...
public class CreateDiGUI extends Application {
	...
	public static final String SCOPE = "SIS.Di";
	// name of this component
    public static final String NAME = "DiGUI";
...
class MonitorTask implements Runnable {
	...
	public void runTask() {
		while (running) {
			try {
				...
				conn.putPair("Scope", CreateDiGUI.SCOPE);
				conn.putPair("MessageType", "Connect");
				conn.putPair("Role", "Monitor");
				conn.putPair("Name", CreateDiGUI.NAME);
	...
	private void ProcessMsg(KeyValueList kvList) throws Exception {
		...
		if (!CreateDiGUI.SCOPE.startsWith(scope)) {
			return;
		}
		...
		case "Connect":
			...
			if (!name.equals(CreateDiGUI.NAME)&&!role.equals("Monitor")) {
