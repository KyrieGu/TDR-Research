...
class ChiStateMachine {
    private String NAME;//controller name
    private String SCOPE;//controller scope
    private ChiState state = ChiState.NORMAL;//current state
    ...
    public ChiStateMachine(String name, String scope, MsgEncoder encoder) {
        this.NAME = name;
        this.SCOPE = scope;
