...
public class CreateReadingBehavior {
	...
	private static void componentTask() {
		try {
			...
			System.out.println(reading.xArray.toString());
			System.out.println(reading.yArray.toString());
			System.out.println(reading.tArray.toString());
	...
	private static void fetch() throws Exception {
		...
		try{
	    	...
	    	while ( line!= null && System.currentTimeMillis()<=(time1+refreshRate*100)){
	    			process(line);
...
class ReadingBehaviorReading {
	...
	StringBuilder tArray = new StringBuilder("");
}
