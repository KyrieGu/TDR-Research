...
public class CreateFlowerUploader2
{
    ...
    private static final String NAME = "FlowerUploader2";
  ...
  /*          case "BloodPressure":
    ...
    private static void update() throws Exception
    {
	    ...
	    execute(formQuery(reading.dateFP,"FlowerPower2","airtemperature",reading.temperature));
        execute(formQuery(reading.dateFP,"FlowerPower2","fertilizer",reading.fertilizer));
        execute(formQuery(reading.dateFP,"FlowerPower2","light",reading.sunshine));
        execute(formQuery(reading.dateFP,"FlowerPower2","moisture",reading.moisture));
