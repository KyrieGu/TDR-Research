...
public class CustomControl extends VBox {
	...
	public void handlerKill(MouseEvent event) {
		...
		try {
			...
			kill.putPair("Sender", CreateFlowerManagerGUI.NAME);
	...
	public void handlerActiveInactive(MouseEvent event) {
		...
		if (selected) {
			...
			try {
				...
				act.putPair("Sender", CreateFlowerManagerGUI.NAME);
			...
			try {
				...
				dact.putPair("Scope", CreateFlowerManagerGUI.SCOPE);
				dact.putPair("MessageType", "Setting");
				dact.putPair("Sender", CreateFlowerManagerGUI.NAME);
