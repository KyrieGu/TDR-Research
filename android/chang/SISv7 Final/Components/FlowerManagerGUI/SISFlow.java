...
public class SISFlow extends GridPane {
	...
	public void handlerChange(MouseEvent event){
		try {
			...
			if(builder.length()>0){
				...
				updateEmail.putPair("Scope", CreateFlowerManagerGUI.SCOPE);
				updateEmail.putPair("MessageType", "Setting");
				updateEmail.putPair("Sender", CreateFlowerManagerGUI.NAME);
	...
	public void handlerSwitch(MouseEvent event){
		try {
			...
			switchUser.putPair("Scope", CreateFlowerManagerGUI.SCOPE);
			switchUser.putPair("MessageType", "Setting");
			switchUser.putPair("Sender", CreateFlowerManagerGUI.NAME);
