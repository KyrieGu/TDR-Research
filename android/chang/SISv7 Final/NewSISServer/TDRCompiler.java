...
public class TDRCompiler {
	 ...
	 *            Util.java
	 */
	public TDRCompiler(String n, String in, String out) {//, ComponentType type) {
	...
	private void generateUtil() {
		Path source = FileSystems.getDefault().getPath("/Users/drzzh/template/Util.s");
	...
	private void generateIndiScript() {
		Path source = FileSystems.getDefault()
				.getPath("/Users/drzzh/template/controllerComponent_individualScript.s");
	...
	private void generateComponent(Pnml pnml) {
		...
		//if (type != null && type == ComponentType.Controller) {
		componentTemplatePath = "/Users/drzzh/Documents/SISv6/NewSISServer/template/componentTemplate.s";
		//} 
		//else if (type != null && type == ComponentType.Coordinator){
		//	componentTemplatePath = "template/componentTemplate_coordinator.s";
		//}
		Path source = FileSystems.getDefault()
				.getPath(componentTemplatePath);
		Path target = FileSystems.getDefault().getPath(
	...
	public static void main(String[] args) throws IOException {
        ...
        GUI.execute();
//		TDRCompiler d = new TDRCompiler("DiController", "/Users/drzzh/Documents/SISv6/ControllerComponents/DiController", "/Users/drzzh/Documents/output");
//		TDRCompiler t = new TDRCompiler("TianController", "/Users/drzzh/Documents/SISv6/ControllerComponents/FlowerManager", "/Users/drzzh/Documents/output");
//		TDRCompiler c = new TDRCompiler("ChiController", "/Users/drzzh/Documents/SISv6/ControllerComponents/ChiController", "/Users/drzzh/Documents/output");
        if(GUI.newXML.name.equals("ChiSensor")) {
            TDRCompiler chiSensor = new TDRCompiler("ChiSensor", "/Users/drzzh/Documents/SISv6/ControllerComponents/ChiSensor", "/Users/drzzh/Documents/output");
        }
        else if (GUI.newXML.name.equals("ChiMonitor")) {
            TDRCompiler monitor = new TDRCompiler("ChiMonitor", "/Users/drzzh/Documents/SISv6/ControllerComponents/ChiMonitor", "/Users/drzzh/Documents/output");
        }
		else if (GUI.newXML.name.equals("ChiController")){
			TDRCompiler controller = new TDRCompiler("ChiController", "/Users/drzzh/Documents/SISv6/ControllerComponents/ChiController", "/Users/drzzh/Documents/output");
		}
		else if (GUI.newXML.name.equals("ChiUploader")){
			TDRCompiler uploader = new TDRCompiler("ChiUploader", "/Users/drzzh/Documents/SISv6/ControllerComponents/ChiUploader", "/Users/drzzh/Documents/output");
		}
	}
}
...
class CompilerGUI{
    public pmnl newXML = new pmnl();
    public CompilerGUI(){

    }
    public void execute() throws IOException {
        runGUI();
        if(newXML.name.equals("ChiSensor")) {
            System.out.println("ChiSensor selected.");
            System.out.println("Choose use: 1 for user input, 2 for sensor input");
            String whichInput = System.console().readLine();
            System.out.println("Choose GUI: 1 for GUI required 2 for GUI not required");
            String requireGUI = System.console().readLine();
        }
		else if(newXML.name.equals("ChiController")){
			System.out.println("ChiController is selected");
			System.out.println("Please Enter Number Component");
			int num = Integer.parseInt(System.console().readLine());
			ArrayList<String> lst = new ArrayList<String>();
			for(int i = 0; i < num; i++){
				System.out.println("Please Enter Component Name");
				lst.add(System.console().readLine());
			}
		}
        // output path here
        newXML.generateXML("/Users/drzzh/Documents/output/");
        System.out.println("Generating IDL file...");
    }
    public pmnl getXML(){
        return newXML;
    }
    ...
    private void runGUI(){
        System.out.println("Please choose which to generate: 1.ChiSensor, 2.ChiMonitor, 3.ChiController, 4.ChiUploader");
//        System.out.println("Please Enter Name:");
        String nameChoice = System.console().readLine();
		if(nameChoice.equals("1")){
			newXML.name = "ChiSensor";
		}
		else if(nameChoice.equals("2")){
			newXML.name = "ChiMonitor";
		}
		else if (nameChoice.equals("3")){
			newXML.name = "ChiController";
		}
		else{
			newXML.name = "ChiUploader";
		}
        System.out.println("Please Enter Scope:");
        newXML.scope = System.console().readLine();
//        System.out.println("Please Enter Component:");
        newXML.component = newXML.name;
//        System.out.println("Please Enter Component Name:");
        newXML.componentName = newXML.name;
        System.out.println("Please Enter Source:");
        newXML.componentSource = System.console().readLine();
        System.out.println("Please Enter Purpose:");
        newXML.componentPurpose = System.console().readLine();
    }
...
class pmnl{
    ...
    public pmnl(String scope, String name, String component, String componentName, String componentPurpose, String componentSource){
        this.scope = scope;
        this.name = name;
    ...
    public void generateXML(String path) throws IOException {
        Path target = FileSystems.getDefault().getPath(
                path + "Components/" + name + "/pnml.xml");
        File outfile = new File(path + "Components/" + name + "/pnml.xml");
        outfile.getParentFile().mkdirs();
        outfile.createNewFile();
        Path source = FileSystems.getDefault().getPath("/Users/drzzh/Documents/SISv6/NewSISServer/template/pnmlTemplate.xml");
        try {
            BufferedReader reader = Files.newBufferedReader(source,
                    StandardCharsets.UTF_8);
            String finalResult = reader.lines()
                    .reduce(new StringBuilder(), (x, y) -> {
                        String newY = y.replaceFirst("!name!", name)
                                .replaceFirst("!scope!", scope)
                                .replaceFirst("!component!", component)
                                .replaceFirst("!componentName!", componentName)
                                .replaceFirst("!componentPurpose!", componentPurpose)
                                .replaceFirst("!componentSource!", componentSource);
                        x.append(newY + "\n");
                        return x;
                    } , (left, right) -> left.append(right.toString()))
                    .toString();
