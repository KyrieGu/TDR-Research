...
//Duncan Adds these two
//import mobi.foo.openbci.utils.
...
public class GraphConnecionFragment extends BaseFragment implements LeScanCallback {
    ...
    ///////////////////////////////////////////////////////////////////////
    //Duncan's Code////////////////////////////////////////////////////////
    private static String serverAddress="192.168.137.1";
    private static int serverPort=53217;
    private static MsgEncoder msgEncoder;
    private static MsgDecoder msgDecoder;
    Socket socket;
    private static final String SENDER = "BCIAlpha";
...
//        	record.putPair("Receiver", "BCIUploader");
        ...
        record.putPair("AlphaValue", Integer.toString(val));
        try {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (RFduinoService.ACTION_CONNECTED.equals(action)) {
                ...
                if (data[0] == (byte) 911) {
                    ...
                    int val = data[0];//Duncan adds Feb 2017
                    sendDataToSISServer(val);//Duncan adds Feb 2017
...
//            msgDecoder = new MsgDecoder(socket.getInputStream());
            ...
            msgEncoder.sendMsg(kvList1);
            //mConnectionStatusText.setText("Done Register");
            //send connect message to SIS Server
            KeyValueList kvList2 = generateConnectMessage();
            msgEncoder.sendMsg(kvList2);
            //mConnectionStatusText.setText("Done Connect");
        }catch(Exception e){
            e.printStackTrace();
        }
        //////////////////////////////////////////////////////////////////////////
