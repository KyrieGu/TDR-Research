...
public class RFduinoService extends Service {
    ...
    public final static String ACTION_CONNECTED =
            "com.openbci.ble.ACTION_CONNECTED";
    public final static String ACTION_DISCONNECTED =
            "com.openbci.ble.ACTION_DISCONNECTED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.openbci.ble.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.openbci.ble.EXTRA_DATA";
    
    //RFDruino Characteristics
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            Log.e("RFduinoService","onConnectionState");
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            Log.e("RFduinoService","onServiceDiscovered");
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            Log.e("RFduinoService","onCharacteristicRead");
            if (status == BluetoothGatt.GATT_SUCCESS) {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            Log.e("RFduinoService","onCharacteristicChanged");
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
        }
    };

    private void broadcastUpdate(final String action) {
        Log.e("RFduinoService","broadcastUpdate1");
    ...
    private void broadcastUpdate(final String action,
        ...
        Log.e("RFduinoService","broadcastUpdate2");
    ...
    public class LocalBinder extends Binder {
        public RFduinoService getService() {
            Log.e("RFduinoService","LocalBinder");
    ...
    public IBinder onBind(Intent intent) {
        ...
        Log.e("RFduinoService","IBinder");
        return mBinder;
    }

    @Override
    public boolean onUnbind(Intent intent) {
        Log.e("RFduinoService","onUnbind");
    ...
    public boolean initialize() {
        Log.e("RFduinoService","initialize");
    ...
    public void disconnect() {
        Log.e("RFduinoService","disconnect");
    ...
    //Send and receive functions specifically for RFDuino
    public void read() {
        Log.e("RFduinoService","read");
    ...
    public static IntentFilter getIntentFilter() {
        Log.e("RFduinoService","getIntentFilter");
