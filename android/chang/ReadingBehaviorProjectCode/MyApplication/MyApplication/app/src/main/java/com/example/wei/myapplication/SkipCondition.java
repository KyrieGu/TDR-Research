...
public class SkipCondition extends ActionBarActivity implements Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.skip_condition);
        context = getApplicationContext();
        preview = (FrameLayout) findViewById(R.id.preview_skip);
        fpFeatureSupported = FacialProcessing.isFeatureSupported(FacialProcessing.FEATURE_LIST.FEATURE_FACIAL_PROCESSING);
        btn_next=(Button)findViewById(R.id.next_btn_skip_condition);
        btn_finish=(Button)findViewById(R.id.finish_btn_skip_condition);
        ...
        mPreview = new CameraSurfacePreview(SkipCondition.this, cameraObj, faceProc);
        ...
        mWebView = (WebView) findViewById(R.id.webview_skip);
...
//        String strJavascript1 = "grayOutRandomSection("+randNum1+","+randNum2+");";
...
public void setUI(int leftEyeBlink, int rightEyeBlink, int faceRollValue, PointF gazePointValue,
    ...
    public void startCamera(int cameraIndex) {
        ...
        preview = (FrameLayout) findViewById(R.id.preview_skip);
        preview.addView(mPreview,0);
        cameraObj.setPreviewCallback(SkipCondition.this);
    }
...
//                setUI(gazePointValue);
    ...
    public void skipNext(View view) {
        ...
        //-------------Face Feature Saving----------------
        String filename0 = "FaceFeature-article"+readingOrder[progressNum]+"_"+count+"_SkipCondition"+System.currentTimeMillis()+".txt";
        //"GazeReadingData.txt";
        try {
            File dir=null;
        ...
        // Gaze Data Saving-------------------------
        String filename = "Gaze-article"+readingOrder[progressNum]+"_"+count+"_SkipCondition"+System.currentTimeMillis()+".txt";
        //"GazeReadingData.txt";
        try {
            File dir=null;
            OutputStreamWriter outputstreamwriter;
        ...
        String filename2 = "Layout-article"+readingOrder[progressNum]+"_"+count+"_SkipCondition"+System.currentTimeMillis()+".txt";;
        try {
            File dir2=null;
    ...
    public void skipFinish(View view) {
        //String directory0 = context.getExternalFilesDir(null) + "/DataCollectionExperiment/USERID_"+userid+"/";
        String directory0;
        if(warmup==1){
            directory0 = context.getExternalFilesDir(null) + "/DataCollectionExperiment/WarmUp/USERID_"+userid+"/";
