...
public class RereadCondition extends ActionBarActivity implements Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reread_condition);
        ...
        btn_next=(Button)findViewById(R.id.next_btn_reread_condition);
        btn_finish=(Button)findViewById(R.id.finish_btn_reread_condition);
        ...
        mPreview = new CameraSurfacePreview(RereadCondition.this, cameraObj, faceProc);
        ...
        mWebView = (WebView) findViewById(R.id.webview_reread);
...
//        String strJavascript1 = "highLightRandomSection("+randNum1+","+randNum2+");";
//        System.out.println("~~~~~~~~~~~~~~~~~~");
//
//        mWebView.evaluateJavascript(strJavascript1, valueCallBackTemp);
    ...
    private void doStuff() {
        ...
        layoutResult.append("RandomNumbers, "+randNum1+", "+randNum2);
...
public void setUI(int leftEyeBlink, int rightEyeBlink, int faceRollValue, PointF gazePointValue,
    ...
    public void startCamera(int cameraIndex) {
        ...
        preview = (FrameLayout) findViewById(R.id.preview_reread);
        preview.addView(mPreview,0);
        cameraObj.setPreviewCallback(RereadCondition.this);
    }
...
//                setUI(gazePointValue);
    ...
    public void rereadNext(View view) {
       // String directory0 = context.getExternalFilesDir(null) + "/DataCollectionExperiment/USERID_"+userid+"/";
        ...
        //-------------Face Feature Saving----------------
        String filename0 = "FaceFeature-article"+readingOrder[progressNum]+"_"+count+"_RereadCondition"+System.currentTimeMillis()+".txt";
        //"GazeReadingData.txt";
        try {
            File dir=null;
        ...
        // Gaze Data Saving-------------------------
        String filename = "Gaze-article"+readingOrder[progressNum]+"_"+count+"_RereadCondition"+System.currentTimeMillis()+".txt";
        //"GazeReadingData.txt";
        try {
            File dir=null;
            OutputStreamWriter outputstreamwriter;
        ...
        String filename2 = "Layout-article"+readingOrder[progressNum]+"_"+count+"_RereadCondition"+System.currentTimeMillis()+".txt";;
        try {
            File dir2=null;
...
//        mWebView.evaluateJavascript(strJavascript1, valueCallBackTemp);
    ...
    public void rereadFinish(View view) {
        onPause();
//        stopCamera();
        //String directory0 = context.getExternalFilesDir(null) + "/DataCollectionExperiment/USERID_"+userid+"/";
        String directory0;
