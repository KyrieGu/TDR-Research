...
class FaceData {
    ...
    public FaceData(int numFaces0, int leftEyeBlink0, int rightEyeBlink0, int faceRollValue0,
    ...
    public static String toCSV(ArrayList<FaceData> arraylist) {
        ...
        for (Iterator<FaceData> iterator = arraylist.iterator(); iterator.hasNext(); ) {
            ...
            stringbuilder.append("" + sample.timestamp + "," + sample.numFaces + ","
                    + sample.leftEyeBlink + "," + sample.rightEyeBlink + "," + sample.faceRollValue + "," + sample.faceYawValue
    ...
    public String getValue() {
        ...
        stringbuilder.append("" + timestamp + "," + numFaces + ","
                + leftEyeBlink + "," + rightEyeBlink + "," + faceRollValue + "," + faceYawValue
    ...
    public boolean equals(Object o) {
        ...
        stringbuilder.append("" + this.timestamp + "," + this.numFaces + ","
                + this.leftEyeBlink + "," + this.rightEyeBlink + "," + this.faceRollValue + "," + this.faceYawValue
...
public class saveFaceData {
    ...
    public static boolean AddFaceDataSample(int numFaces0, int leftEyeBlink0, int rightEyeBlink0, int faceRollValue0,
                                    int faceYawValue0, int facePitchValue0, PointF gazePointValue0, int horizontalGazeAngle0, int verticalGazeAngle0, long timestamp0) {
        if (instance != null) {
            instance.addFaceDataSamples(numFaces0, leftEyeBlink0, rightEyeBlink0, faceRollValue0, faceYawValue0, facePitchValue0, gazePointValue0, horizontalGazeAngle0, verticalGazeAngle0, timestamp0);
            return true;
        }
    ...
    public void addFaceDataSamples(int numFaces0, int leftEyeBlink0, int rightEyeBlink0, int faceRollValue0,
                    int faceYawValue0, int facePitchValue0, PointF gazePointValue0, int horizontalGazeAngle0, int verticalGazeAngle0, long timestamp0) {
        if (samples != null) {
            FaceData sample = new FaceData(numFaces0, leftEyeBlink0, rightEyeBlink0, faceRollValue0, faceYawValue0, facePitchValue0, gazePointValue0, horizontalGazeAngle0, verticalGazeAngle0, timestamp0);
            samples.add(sample);
        }
    }
    ...
    public String save( String title, long time ) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("DataStorageHrv", e.toString());
        }
        return "saved";
    }
