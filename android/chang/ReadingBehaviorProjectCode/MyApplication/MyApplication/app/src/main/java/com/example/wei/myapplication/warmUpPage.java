...
public class warmUpPage extends ActionBarActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.warm_up_0);
        ...
        if(progressNum<4){
            if(conditionOrder[progressNum]==1){
                textView1.setText("Please first watch the instruction slides carefully. Then we can start. \n" +
                        "\n\n" +
                        "Please read the following article with 3 pages under NORMAL SEQUENCIAL CONDTION. " +
            ...
            textView1.setText("Warm Up finished. \nPlease remember that the conditions are going to display with random order" +
                    ". Read the instruction before you start each condition. \nWhenever you start, put your phone down until the " +
                    "pop up word disappears. \nDuring your reading, keep your phone as static as possible. \nWe are recording your " +
                    "face during your reading. Therefore hold the phone and try to let front camera of phone catch your face." +
                    "\n\nClick start button down here to re-insert your userID.");
        }
