...
function [selectedSig] = fastica(mixedsig)

%Input: each row of matrix mixedsig is one observed signal
%Output: selectedSig which is the most periodic independent component
