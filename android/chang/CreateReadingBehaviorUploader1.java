  ...
  /*          case "BloodPressure":
    ...
    private static void update() throws Exception
    {
        ...
        for(int tempi=0;tempi<numTemp;tempi++){
        	execute(formQuery(reading.tArray.get(tempi),"ReadingBehavior","GazeX",reading.xArray.get(tempi)));
        	execute(formQuery(reading.tArray.get(tempi),"ReadingBehavior","GazeY",reading.yArray.get(tempi)));
        	System.out.println("Updating GazeX:"+reading.xArray.get(tempi));
        	System.out.println("Updating GazeY:"+reading.yArray.get(tempi));
        }
